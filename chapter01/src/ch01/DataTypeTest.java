...
public class DataTypeTest {
	...
	public static void main(String[] args) {
		...
		char name3 = 'A';
		//4.실수 float 타입으로 0.12345678을 name4 이름으로 변수에 담아
		float name4 = 0.12345678f;
		//5.실수 double 타입으로 200.0035를 name5 이름으로 변수에 담아 보세요.
		double name5 = 200.0035;
		//6.논리 자료형 isOk 이름의 변수를 선언해보세요
		boolean isOk;	//카멜노테이션 표기 - 낙타 표기법
		//7.isOk 변수에 값을 false로 초기화 해보세요
		isOk = false;
		//8.isOk 변수에 값을 true로 변경해보세요
		isOk = true;
		//9 변수란 무엇인지 서술하시오
		//변수는 자료형에 맞춰서 변할수있는값을 저장하는 메모리 공간.
		//10.기본 데이터 타입에 종류 8가지를 서술해 보세요.
		//정수형:byte,short,int,long (1,2,4,8 바이트) 
		//실수형:float,double (4,8바이트)
		//문자형:char (2바이트)
		//논리형:boolean	(1바이트)
	}
